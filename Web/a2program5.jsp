					...
					<div class="row justify-content-between align-items-center pb-120 appointment-wrap">
						...
						<div class="col-lg-4" style="box-shadow: 0px 1px 16px 0px #DCDCDC;">
							...
							<form class="form-wrap" action="a2program5.jsp" method="get">
                                ...
                                <h3>  <%= product1.getProductName() %> </h3>
                                <p>Price: <%= product2.getProductPrice() %> Rupees</p>
                        ...
                        <div class="col-lg-4" style="box-shadow: 0px 1px 16px 0px #DCDCDC;">
							<form class="form-wrap" action="a2program5.jsp" method="get">
                                ...
                                <h3>  <%= product3.getProductName() %> </h3>
                                <p>Price: <%= product3.getProductPrice() %> Rupees</p>
