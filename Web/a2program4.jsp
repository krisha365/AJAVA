<%-- 
    Document   : a2program4
    Created on : Feb 13, 2020, 7:59:45 PM
    Author     : PARTH
--%>
					...
					<div class="row justify-content-between align-items-center pb-120 appointment-wrap">
						...
						<div class="col-lg-6 col-md-6 appointment-right pt-60 pb-60" style="box-shadow: 0px 1px 16px 0px #DCDCDC;">
							<form class="form-wrap" action="">
								<h3 class="pb-20 text-center mb-30">Dynamically Field Generation</h3>
								<input type="number" class="form-control" name="fieldNo" placeholder="Number of Text Fields" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Number of Text Fields'" >
								<input type="submit" name="submit" class="primary-btn text-uppercase" value="Generate"/>
                                <br>
                                <%
        try {
            if (request.getParameter("submit") != "")
            {
                int num = Integer.parseInt(request.getParameter("fieldNo"));
                for(int i=1;i<=num;i++)
                {
                    out.println("<input class='form-control' type='text' placeholder='Textbox"+ i +"'/>");
                }
