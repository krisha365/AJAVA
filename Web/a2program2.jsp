<%-- 
    Document   : a2program2
    Created on : Jan 24, 2020, 11:21:03 AM
    Author     : PARTH
--%>
					...
					<div class="row justify-content-between align-items-center pb-120 appointment-wrap">
						...
						<div class="col-lg-6 col-md-6 appointment-right pt-60 pb-60" style="box-shadow: 0px 1px 16px 0px #DCDCDC;">
							<form class="form-wrap" action="" method="post">
								...
								<input type="email" class="form-control" name="emai1l" placeholder="Email Address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email Address'" >
								...
								<input type="submit" name="submit" class="primary-btn text-uppercase"/>
                                <%if(request.getParameter("submit")!= null){
                                if((request.getParameter("emai1l")).equals("kc.krishnachavda77@gmail.com") &&
                                        (request.getParameter("password1")).equals("admin") )
                                {
                                  out.println("<h4 class='pb-20 text-center mb-30 mt-20'>Welcome " + request.getParameter("email")+ "</h4>");} else {out.println("<h4 class='pb-20 text-center mb-30 mt-20'> Error! Wrong Credentials</h4>");}
                                }        %>
							</form>
